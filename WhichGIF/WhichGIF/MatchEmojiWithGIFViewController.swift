//
//  MatchEmojiWithGIFViewController.swift
//  WhichGIF
//
...
class MatchEmojiWithGIFViewController: UIViewController {
    ...
    @IBOutlet weak var emoji4Label: UILabel!
    @IBOutlet weak var emoji5Label: UILabel!
    @IBOutlet weak var emoji6Label: UILabel!
    ...
    override func viewDidLoad() {
        ...
        startTimer()
        emoji1Label.addInteraction(UIDragInteraction(delegate: self))
        emoji2Label.addInteraction(UIDragInteraction(delegate: self))
        emoji3Label.addInteraction(UIDragInteraction(delegate: self))
        emoji4Label.addInteraction(UIDragInteraction(delegate: self))
        emoji5Label.addInteraction(UIDragInteraction(delegate: self))
        emoji6Label.addInteraction(UIDragInteraction(delegate: self))
...
extension MatchEmojiWithGIFViewController: UIDragInteractionDelegate {
...
extension MatchEmojiWithGIFViewController: UIDropInteractionDelegate {
